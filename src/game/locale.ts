export const LOCALE = {
  ...
  LEADERBOARD: 'Топ забегов',

  CLASS_TITLE: 'Выберите класс',
  RELIC_PICK_TITLE: 'Выберите реликвию',
  RELIC_PICK_SUB: 'Один артефакт на весь забег',
  DAILY_SEED: 'Seed дня',

  MAP_FLOOR: 'Этаж',
  DECK_VIEW: 'Колода',
  DECK_TITLE: 'Ваша колода',
  DECK_TOTAL: 'Всего',

  NODE_LABELS: {
    combat: 'Бой', elite: 'Элита', boss: 'Босс', rest: 'Костёр',
    shop: 'Лавка', treasure: 'Сундук', event: 'Событие',
  ...
  REST_SMITH: 'Кузница',
  REST_SMITH_HINT: 'Улучшить карту',

  SMITH_TITLE: 'Кузница',
  SMITH_CHOOSE: 'Выберите карту для улучшения:',
  SMITH_SKIP: 'Назад',
